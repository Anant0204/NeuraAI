  ...
  return (
    <div className="min-h-screen bg-amber-50/20 px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        {user.isSetupComplete && !editAssistant && (
          <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 mb-6">
            ...
            <p className="text-gray-500 mt-3 leading-7">
              Your assistant is ready to use on website.
            </p>
            ...
            <div className="mt-7">
              ...
              <p className="text-sm font-medium text-gray-900 mb-3 mt-4">
                Embed Code
              </p>
            </div>
            ...
            <div className="relative">
              <textarea
                value={embedCode}
                readOnly
                className="w-full h-20 bg-gray-900 text-cyan-400 rounded-2xl p-4 text-sm font-mono resize-none outline-none"
              />
              <button
                onClick={() => {
                ...
                className="cursor-pointer absolute top-4 right-4 w-10 h-10 rounded-xl bg-white flex items-center justify-center"
              >
                <FaRegCopy />
              </button>
            </div>
            ...
            <button
              ...
              className="mt-6 h-12 px-6 rounded-2xl bg-gradient-to-r from-purple-400 to-cyan-400 text-white font-medium"
            >
              Edit Assistant
            </button>
          </div>
        ...
        !businessDescription ||
        !geminiAPIKey}
              className="w-full h-14 rounded-2xl bg-gradient-to-r from-purple-500 to-cyan-400 text-white font-bold disabled:opacity-55 disabled:cursor-not-allowed"
            >
              {loading
                ? "Saving..."
